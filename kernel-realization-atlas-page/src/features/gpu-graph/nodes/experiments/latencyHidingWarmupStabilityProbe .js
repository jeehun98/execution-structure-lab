const latencyHidingWarmupStabilityProbe = {
  ...
  graphSummary: {
    ...
    keyTakeaway:
      "핵심은 dependent_global_stalled의 낮은 progress sample이 eviction 조건에서 재현되고, measured-after-global-chain-warmup 조건에서는 약 81~82 수준으로 안정화된다는 점입니다.",
