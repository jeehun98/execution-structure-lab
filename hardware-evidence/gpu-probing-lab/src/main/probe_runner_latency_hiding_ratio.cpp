#include "../probes/latency_hiding_ratio_probe/host.hpp"
...
using latency_hiding_ratio_probe::Config;
using latency_hiding_ratio_probe::run_probe;
...
int main(int argc, char** argv) {
    try {
        std::string config_path =
            "configs/latency_hiding_ratio_probe.cfg";
        ...
        std::cerr
            << "[latency_hiding_ratio_probe] error: "
            << e.what()
            << "\n";
