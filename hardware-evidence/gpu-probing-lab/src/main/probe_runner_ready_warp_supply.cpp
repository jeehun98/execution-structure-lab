#include "../probes/ready_warp_supply_probe/host.hpp"
...
using ready_warp_supply_probe::Config;
using ready_warp_supply_probe::run_probe;
...
int main(int argc, char** argv) {
    try {
        std::string config_path =
            "configs/ready_warp_supply_probe.cfg";
