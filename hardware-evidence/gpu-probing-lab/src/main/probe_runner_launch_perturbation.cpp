#include "../probes/launch_perturbation_probe/host.hpp"
...
using launch_perturbation_probe::Config;
using launch_perturbation_probe::run_probe;
...
int main(int argc, char** argv) {
    try {
        std::string config_path =
            "configs/launch_perturbation_probe.cfg";
        ...
        std::cerr
            << "[launch_perturbation_probe] error: "
            << e.what()
            << "\n";
