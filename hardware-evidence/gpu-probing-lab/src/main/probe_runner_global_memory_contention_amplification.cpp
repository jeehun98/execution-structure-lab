#include "../probes/global_memory_contention_amplification_probe/host.hpp"
...
using global_memory_contention_amplification_probe::Config;
using global_memory_contention_amplification_probe::run_probe;
...
int main(int argc, char** argv) {
    try {
        std::string config_path =
            "configs/global_memory_contention_amplification_probe.cfg";
        ...
        std::cerr
            << "[global_memory_contention_amplification_probe] error: "
            << e.what()
            << "\n";
