...
std::string role_name_from_id(int role_id) {
    switch (role_id) {
        case 0:
            return "dependent_fma_7";
        case 1:
            return "independent_fma_7_2acc_4_3";
        case 2:
            return "independent_fma_7_3acc_3_2_2";
        case 3:
            return "independent_fma_7_4acc_tail_a3_missing";
        case 4:
            return "independent_fma_7_4acc_tail_a0_missing";
        case 5:
            return "independent_fma_7_7acc_once";
        case 6:
            return "dependent_fma_8";
        case 7:
            return "independent_fma_8_4acc_balanced";
        default:
            return "unknown";
    }
}
...
std::vector<ArithmeticProbeRecord> run_chain7_tail_distribution_probe(
    ...
    if (warps_per_block < 8) {
        throw std::runtime_error(
            "chain7_tail_distribution_probe requires at least 8 warps per block. "
    ...
    for (int run = 0; run < repeat; ++run) {
        ...
        launch_chain7_tail_distribution_kernel(
            d_records,
            blocks,
            threads_per_block,
            clock_budget_cycles,
