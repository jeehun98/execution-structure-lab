...
extern "C" cudaError_t launch_initialize_shared_memory_ready_interference_global_buffer(
    std::uint32_t* global_buffer,
    int global_buffer_size,
    std::uint32_t seed
);

extern "C" cudaError_t launch_shared_memory_ready_interference_kernel(
...
namespace shared_memory_ready_interference_probe {
...
static const char* role_name(int role_id) {
    switch (role_id) {
        ...
        case 1: return "shared_no_conflict_ready";
        case 2: return "shared_bank_conflict_ready";
        case 3: return "shared_dependent_chain_ready";
        case 4: return "dependent_global_stalled";
...
static const char* condition_name(int condition_id) {
    switch (condition_id) {
        ...
        case 1: return "shared_no_conflict_ready_vs_global_stalled";
        case 2: return "shared_bank_conflict_ready_vs_global_stalled";
        case 3: return "shared_dependent_chain_ready_vs_global_stalled";
        case 4: return "mixed_shared_ready_vs_global_stalled";
...
static void write_json(
    ...
    out << "  \"probe_name\": \"shared_memory_ready_interference_probe\",\n";

    out << "  \"interpretation\": {\n";
    out << "    \"primary_question\": "
        << "\"Which shared-memory ready source increases global-stall variability?\",\n";
    out << "    \"note\": "
        << "\"This probe decomposes shared_load_ready into no-conflict, bank-conflict, and dependent-chain variants. Progress values are execution signatures, not absolute throughput ratios.\"\n";
    out << "  },\n";

    out << "  \"role_map\": {\n";
    out << "    \"0\": \"light_alu_ready\",\n";
    out << "    \"1\": \"shared_no_conflict_ready\",\n";
    out << "    \"2\": \"shared_bank_conflict_ready\",\n";
    out << "    \"3\": \"shared_dependent_chain_ready\",\n";
    out << "    \"4\": \"dependent_global_stalled\"\n";
    out << "  },\n";
...
void run_probe(const Config& config) {
    ...
    cuda_check(
        launch_initialize_shared_memory_ready_interference_global_buffer(
            d_global_buffer,
            config.global_buffer_size,
            0x12345678u
        ),
    ...
    for (int r = 0; r < config.warmup_runs; ++r) {
        ...
        cuda_check(
            launch_shared_memory_ready_interference_kernel(
                d_progress,
                d_role_id,
                d_global_buffer,
                config.global_buffer_size,
    ...
    std::cout << "[shared_memory_ready_interference_probe] done\n";
