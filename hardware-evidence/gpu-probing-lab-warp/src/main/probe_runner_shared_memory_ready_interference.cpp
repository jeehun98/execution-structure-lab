#include "../probes/shared_memory_ready_interference_probe/host.hpp"
...
using shared_memory_ready_interference_probe::Config;
using shared_memory_ready_interference_probe::run_probe;
...
int main(int argc, char** argv) {
    try {
        std::string config_path =
            "configs/shared_memory_ready_interference_probe.cfg";
        ...
        std::cerr
            << "[shared_memory_ready_interference_probe] error: "
            << e.what()
            << "\n";
