#include "../probes/warp_signature_permutation_probe/host.hpp"
...
using warp_signature_permutation_probe::Config;
using warp_signature_permutation_probe::run_probe;
...
int main(int argc, char** argv) {
    try {
        std::string config_path = "configs/warp_signature_permutation_probe.cfg";
        ...
        config.num_runs_per_permutation =
            get_int(kv, "num_runs_per_permutation", config.num_runs_per_permutation);

        config.num_permutations =
            get_int(kv, "num_permutations", config.num_permutations);
        ...
        std::cerr << "[warp_signature_permutation_probe] error: "
                  << e.what()
                  << "\n";
        return 1;
    }
