#include "../probes/composition_transient_probe/host.hpp"
...
using composition_transient_probe::Config;
using composition_transient_probe::run_probe;
...
int main(int argc, char** argv) {
    try {
        std::string config_path =
            "configs/composition_transient_probe.cfg";
        ...
        std::cerr
            << "[composition_transient_probe] error: "
            << e.what()
            << "\n";
